...
import com.mjr.mihiserver.RequestProcessorKt;
...
public class Application extends AbstractHandler
{
    ...
    private static int getPort() {
        ...
        if (port == null) {return 5000;} else {return Integer.parseInt(port);}
    }

    private void handleHttpRequest(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        // Handle HTTP requests here.
//        response.getWriter().println(INDEX_HTML);
        HttpServlet handler = RequestProcessorKt.getHandler();
        javax.servlet.ServletRequest servletRequest = request;
        javax.servlet.ServletResponse servletResponse = response;
    ...
    {
        RequestProcessorKt.getConnection();
